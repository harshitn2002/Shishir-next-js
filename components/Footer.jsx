...
export default function Footer() {
  return (
    <footer className="main-footer-data bg-lavender overflow-hidden text-[#012AB1] flex flex-row items-start justify-between px-32 text-left text-darkslateblue foot_new">
