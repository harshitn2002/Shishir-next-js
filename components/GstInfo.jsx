    ...
    >
      <div className="  flex flex-col flex-wrap items-start justify-start mb-8 ">
        ...
        <div className="   text-xl  text-justify ">
          ...
          <p className="m-0 font-medium gst_p">
      ...
      <div className="  flex flex-col flex-wrap  items-start justify-start mb-8">
        ...
        <div className="  text-xl font-medium text-justify mb-12">
          <p className="m-0 gst_p">{`The Goods and Services Tax (GST) marks a significant shift for Indian businesses. While it promises a more streamlined business environment, it also brings new hurdles to navigate. At Shishir & Co., we can help you navigate this transition seamlessly.`}</p>
          <p className="m-0">&nbsp;</p>
          <p className="m-0 gst_p">
          ...
          <p className="m-0">&nbsp;</p>
          <p className="m-0 gst_p2">Let Shishir & Co. be your partner in maximizing the benefits of GST and minimizing disruption. Focus 
            on your core business while we handle the tax complexities.</p>
        </div>
      </div>
    </div>
  );
