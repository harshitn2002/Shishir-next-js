...
export default function Contact() {
  return (
    <div
      className="abt-cont  my-16 flex flex-wrap justify-between items-center px-20 con_now"
      id="contact"
    >
      <div className="about flex flex-wrap w-full justify-center items-center flex-col pt-12 pb-12 pl-8 pr-8">
        <div className="abt-head text-white mb-8 text-3xl font-bold text-center flex flex-wrap items-center justify-center con_2">
